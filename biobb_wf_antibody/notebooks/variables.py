...
MD_output_npt_xtc = MD_dir / 'antibody_npt.xtc'
...
MD_output_md_xtc = MD_dir / 'antibody_md.xtc'
...
MD_imaged_traj = MD_dir / 'antibody_imaged_traj.xtc'
...
AWH_output_min_xtc = AWH_dir / 'complex_min.xtc'
...
AWH_output_nvt_xtc = AWH_dir / 'complex_nvt.xtc'
...
AWH_output_npt_xtc = AWH_dir / 'complex_npt.xtc'
...
AWH_imaged_traj = AWH_dir / 'complex_imaged_traj.xtc'
AWH_dry_gro = AWH_dir / 'complex_md_dry.gro'
AWH_imaged_traj_rot = AWH_dir / 'complex_imaged_traj_rot.xtc'
AWH_loop_ndx = AWH_dir / 'complex_loop.ndx'
AWH_imaged_traj_fw = AWH_dir / 'complex_imaged_traj_fw.xtc'
...
AWH_pdb_cluster = AWH_dir / 'antibody_clusters.pdb'
AWH_aligned_clusters_pdb = str(AWH_dir / 'antibody_clusters_aligned.pdb')
