...
MD_dry_pdb = MD_dir / 'antibody_md_dry.pdb'  # same system as the .gro, cpptraj needs a topology
...
MD_cluster_dat = MD_dir / 'antibody_cluster.dat'
...
AWH_dry_pdb = AWH_dir / 'complex_md_dry.pdb'
...
AWH_cluster_dat = AWH_dir / 'complex_cluster.dat'
